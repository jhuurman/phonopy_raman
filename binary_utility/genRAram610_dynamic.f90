...
!         read(char1(1:4),*) n_frequency
        ...
        4000 do 
          ...
          if(char1=="<dielectricfunction>") then
            exit
          end if
        end do
        ...
        do i=1,n_frequency
          read(15,*)  char1, frequency(i), eps_imag_mat(i,1,1),eps_imag_mat(i,2,2),eps_imag_mat(i,3,3), eps_imag_mat(i,1,2),eps_imag_mat(i,2,3),eps_imag_mat(i,1,3)
          eps_imag_mat(i,2,1)=eps_imag_mat(i,1,2)
          eps_imag_mat(i,3,2)=eps_imag_mat(i,2,3)
          eps_imag_mat(i,3,1)=eps_imag_mat(i,1,3)
        end do
        ...
        do i=1,n_frequency
          read(15,*)  char1, frequency(i), eps_real_mat(i,1,1),eps_real_mat(i,2,2),eps_real_mat(i,3,3), eps_real_mat(i,1,2),eps_real_mat(i,2,3),eps_real_mat(i,1,3)
          eps_real_mat(i,2,1)=eps_real_mat(i,1,2)
          eps_real_mat(i,3,2)=eps_real_mat(i,2,3)
          eps_real_mat(i,3,1)=eps_real_mat(i,1,3)
        end do
